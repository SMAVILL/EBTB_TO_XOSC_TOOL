        ...
        for obj, value in obj_entities.items():
            ...
            if obj_entities[obj][3] == 'car':
                ...
                if obj == 'Obj2':
                    ...
                    target_obj = self.VehicleDefines.target_vehicle_and_entities(target_name=obj, model="Chevrolet Camaro",
                                                                                 default_cat=False,
                                                                                 entity_type='Vehicle',
                ...
                if obj == 'Obj5':
                    ...
                    target_obj = self.VehicleDefines.target_vehicle_and_entities(target_name=obj, model="Bentley Continental GT",
                                                                                 default_cat=False,
                                                                                 entity_type='Vehicle',
            ...
            try :
                try:
                    ...
                    landmark_start = EBTB_API_data.obj_landmark_start_init(states_analysis=states_analysis,
                                                                            target_name=target_name,paramlist_analysis=paramlist_analysis)
